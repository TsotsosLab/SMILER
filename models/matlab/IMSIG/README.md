# The Image Signature (IMSIG)

The Image Signature (IMSIG) saliency model is based on work in the following paper:

```
X. Hou, J. Harel, and C. Koch. Image signature: Highlighting sparse salient regions. IEEE Transactions on Pattern Analysis and Machine Intelligence, 34:194–201, 2012.
```
