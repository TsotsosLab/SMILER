...
Saliency Using Natural statistics (SUN) is based on work in the following paper:

```
Zhang, Lingyun, et al. "SUN: A Bayesian framework for saliency using natural statistics." Journal of vision 8.7 (2008): 32.This is the matlab function that generates saliency maps used in paper Lingyun Zhang, Matthew H. Tong, Tim K. Marks, Honghao Shan & Garrison W. Cottrell (2008). SUN: A Bayesian framework for saliency using natural statistics. Journal of Vision, 8(7):32, 1-20, http://journalofvision.org/8/7/32/, doi:10.1167/8.7.32
```
